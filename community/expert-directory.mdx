...
>
  ...
  <div className="card-content">
    <h3>Aitoflo</h3>
    <p>At Aitoflo, we specialize in Voice AI and RPA services, seamlessly flowing to streamline business operations and enhance  customer interactions with Realistic Voice AI.</p>
  </div>
</Card>
...
>
  <img
    className="card-img bg:white"
    noZoom
    src="https://cdn.discordapp.com/attachments/1261568566704996465/1267338198414131201/AMPLIFY_VOICE_LOGO.png?ex=66b4f26c&is=66b3a0ec&hm=85f5f5ae90bcbcaacdf60eaf9087b0119fc8f72ce666699c4368769d8fa202bf&"
  />
  <div className="card-content">
    <h3>Amplify Voice</h3>
    <p>Our hyper-focus on User Experience will WOW your customers. Click to Book a Strategy Session.</p>
  </div>
</Card>
...
>
  <img
    className="card-img bg:white"
    noZoom
    src="https://www.iffort.ai/assets/mirai-images/iffort.ai-logo.svg"
  />
  <div className="card-content">
    <h3>iffort.ai</h3>
    <p>
