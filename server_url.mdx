---
title: "Set up your Server URL"
sidebarTitle: "Server URL"
description: "Learn how to set up your server to receive and respond to messages from Vapi."
---

<Info>In the Account dashboard page, you can optionally specify a `Server URL`. This is your server's URL that the assistant will use when sending status updates, performing function calls, and more.</Info>
...
<Info>Vapi fully supports [OpenAI's function calling API](https://platform.openai.com/docs/guides/gpt/function-calling), so you can have assistants ping your server to perform actions like sending emails, retrieve information, and more.</Info>
...
<Note>If you don't need to return a response, you can use the `async: true` parameter in your assitant's function configuration. This will prevent the assistant from waiting for a response from your server.</Note>
