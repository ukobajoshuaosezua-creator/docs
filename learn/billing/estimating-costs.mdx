...
<AccordionGroup>
  <Accordion title="Transcription Provider Estimates" defaultOpen={true}>
  ...
  <Accordion title="Telephony Provider Estimates" defaultOpen={true}>
    <Card title="Telephony Provider">
      - Twilio: **\$0.01/min** (=\$0.60/hr) <br /> Vonage: **\$0.01/min** (=\$0.60/hr)
    </Card>
  </Accordion>
</AccordionGroup>
