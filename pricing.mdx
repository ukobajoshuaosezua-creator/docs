...
When using [Provider Keys](/provider_keys), you'll be billed directly by the provider, not us. When not using Provider Keys, you'll be billed at what we've estimated to be our average cost / min. It'll sometimes be cheaper through us too, since we get volume pricing.
...
<Card title="Voice Provider">
  ...
  <br /> OpenAI: **\$0.10/min** (=\$6.00/hr) <br /> Deepgram: **\$0.05/min** (=\$3.00/hr) <br /> RimeAI: **\$0.02/min** (=\$1.20/hr)
</Card>
