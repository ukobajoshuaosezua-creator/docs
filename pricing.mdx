...
We bill you for the Transcription and Voice services **at cost**. If you choose to go with a LLM we offer through the platform, you will be billed for the Model **at cost**. 
