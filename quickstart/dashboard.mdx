...
<Tip>
  ...
  your account will simply be charged directly [**at-cost**](/glossary#at-cost) (no additional charge, no profit to Vapi).
...
<Frame>
  <img src="/static/graphics/quickstart/dashboard/transcriber-providers-keys.png" />
</Frame>
...
<Frame caption="Call into your assistant via the dashboard.">
  <img src="/static/graphics/quickstart/dashboard/call-assistant-web-dashboard.png" />
</Frame>
...
<Frame caption="Make sure you are in the 'Phone Numbers' dashboard tab.">
  <img src="/static/graphics/quickstart/dashboard/buy-a-phone-number.png" />
</Frame>
...
<Frame caption="Choose an area code for your phone number.">
  <img src="/static/graphics/quickstart/dashboard/buy-phone-number-modal.png" />
</Frame>
...
<Frame caption="Here we can attach an assistant to the number for inbound calls (or perform an outbound call, with a select assistant).">
  <img src="/static/graphics/quickstart/dashboard/phone-number-config.png" />
</Frame>
...
<Frame caption="Your assistant will now pick-up calls made to this phone number.">
  <img src="/static/graphics/quickstart/dashboard/inbound-assistant-set.png" />
</Frame>
