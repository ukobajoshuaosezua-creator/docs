...
<Steps>
  <Step title="Create an assistant">
    ...
    Since we want the assistant to remember where we left off, its configuration is going to change based on the caller. So, we're not going to use [temporary assistants](/persistent_assistants).
